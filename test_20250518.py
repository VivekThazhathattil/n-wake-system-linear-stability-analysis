# We use a grid of complex wavenumber values. From the generalized eigenvalue problem for a 
# given complex wavenumber, we obtain the phase speed, from which we substitute back to get the
# complex frequency. We then plot the contour of the imaginary part of the complex frequency.
# This is a test script to check the functionality of the code.
